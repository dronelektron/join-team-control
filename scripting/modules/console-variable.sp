...
void Variable_Create() {
    g_alliesLimit = CreateConVar("sm_jointeamcontrol_limit_allies", "16", "Maximum number of players in the Allies team");
    g_axisLimit = CreateConVar("sm_jointeamcontrol_limit_axis", "16", "Maximum number of players in the Axis team");
